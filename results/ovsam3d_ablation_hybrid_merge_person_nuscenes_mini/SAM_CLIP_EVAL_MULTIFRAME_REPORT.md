...
- `outputs/ovsam3d_ablation_hybrid_merge_person_nuscenes_mini/multiframe_sam_open_vocab_bev.png`
- `outputs/ovsam3d_ablation_hybrid_merge_person_nuscenes_mini/multiframe_sam_open_vocab_points.ply`
