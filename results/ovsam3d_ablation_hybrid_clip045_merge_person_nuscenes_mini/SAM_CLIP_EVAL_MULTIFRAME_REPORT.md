...
Config: `label_mode=hybrid`,
`merge_person_labels=True`.

| Sample | Points | Box assigned ratio | SAM assigned ratio | Box mapped accuracy | SAM mapped accuracy |
| --- | ---: | ---: | ---: | ---: | ---: |
| sample_000 | 34688 | 0.311 | 0.171 | 0.072 | 0.136 |
| sample_001 | 34720 | 0.371 | 0.248 | 0.230 | 0.341 |
| sample_002 | 34720 | 0.154 | 0.105 | 0.191 | 0.256 |
| sample_003 | 34688 | 0.327 | 0.265 | 0.240 | 0.342 |
| sample_004 | 34752 | 0.347 | 0.214 | 0.343 | 0.490 |
...
- `outputs/ovsam3d_ablation_hybrid_clip045_merge_person_nuscenes_mini/multiframe_sam_open_vocab_bev.png`
- `outputs/ovsam3d_ablation_hybrid_clip045_merge_person_nuscenes_mini/multiframe_sam_open_vocab_points.ply`
